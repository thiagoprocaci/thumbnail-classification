...
Once have our features as the input features, we defined the CNN architecture.
We put two 2d convolutions followed by relu activation function in the convolution layer.
